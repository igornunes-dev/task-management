...
// Componente para os links de paginação
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-8 p-4 md:p-8">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-bold text-white">Todas as Tarefas</h1>
                        <p className="text-gray-400">Organize e acompanhe as suas atividades.</p>
                    </div>
                    <Link
