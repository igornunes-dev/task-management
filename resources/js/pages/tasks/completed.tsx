        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-8 p-4 md:p-8">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-bold text-white">Tarefas Concluídas</h1>
                        <p className="text-gray-400">Veja todas as tarefas que já foram finalizadas.</p>
                    </div>
                    <Link
                    ...
                    <div className="divide-y divide-[#3E3E3A]">
                        {tasks.data.length > 0 ? (
                            ...
                            <div className="flex h-48 items-center justify-center">
                                <p className="text-gray-400">Nenhuma tarefa concluída encontrada!</p>
                            </div>
                        )}
                    </div>
                </div>
